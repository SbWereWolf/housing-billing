...
use App\Repository\LocationBillingOptionRepository;
...
#[ORM\UniqueConstraint(name: 'location_billing_option_billing_option_id_location_option_id_ui', columns: [
    'billing_option_id',
    'location_option_id'
])]
#[ORM\Entity(repositoryClass: LocationBillingOptionRepository::class)]
