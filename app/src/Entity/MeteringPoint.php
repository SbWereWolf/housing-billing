...
use App\Repository\MeteringPointRepository;
...
#[ORM\UniqueConstraint(name: 'metering_point_product_distributor_address_point_ux', columns: [
    'product_id',
    'distributor_id',
    'address_id',
    'distribution_point_id'
])]
#[ORM\UniqueConstraint(name: 'metering_point_product_id_distributor_id_point_id_ux', columns: [
    'product_id',
    'distributor_id',
    'distribution_point_id'
])]
#[ORM\Entity(repositoryClass: MeteringPointRepository::class)]
class MeteringPoint
{
    use HasAddress;
    use HasProduct;
